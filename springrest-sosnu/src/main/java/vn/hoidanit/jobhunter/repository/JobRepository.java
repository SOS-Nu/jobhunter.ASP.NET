...
public interface JobRepository extends JpaRepository<Job, Long>,
  ...
  @Query("SELECT DISTINCT j FROM Job j JOIN j.skills s WHERE s IN :skills AND j.active = true")
  Set<Job> findBySkillsIn(@Param("skills") List<Skill> skills);
  ...
  int deactivateExpiredJobsBatch(@Param("now") java.time.Instant now);
