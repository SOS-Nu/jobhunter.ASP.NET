...
import vn.hoidanit.JobZone.domain.entity.PaymentHistory;
import vn.hoidanit.JobZone.domain.entity.User;
import vn.hoidanit.JobZone.domain.response.PaymentHistoryDTO;
import vn.hoidanit.JobZone.domain.response.PaymentUrlResponseDTO;
import vn.hoidanit.JobZone.domain.response.RestResponse;
import vn.hoidanit.JobZone.domain.response.ResultPaginationDTO;
import vn.hoidanit.JobZone.repository.PaymentHistoryRepository;
import vn.hoidanit.JobZone.service.PaymentExportService;
...
public class PaymentController {
    ...
    @PostConstruct
    public void init() {
        log.info("PaymentController initialized AFTER injection with vnp_HashSecret configured.");
    }
    ...
    public ResponseEntity<RestResponse<PaymentUrlResponseDTO>> createPaymentUrl(HttpServletRequest request)
        ...
        log.debug("VNPAY hashData prepared.");

        String secureHash = hmacSHA512(vnpHashSecret, hashData.toString());
        log.debug("vnp_SecureHash generated.");
