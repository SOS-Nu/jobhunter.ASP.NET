...
import vn.hoidanit.JobZone.domain.request.ReqChangePasswordDTO;
import vn.hoidanit.JobZone.domain.request.ReqGoogleLoginDTO;
import vn.hoidanit.JobZone.domain.request.ReqDeleteSessionsDTO;

import vn.hoidanit.JobZone.domain.request.ReqLoginDTO;
import vn.hoidanit.JobZone.domain.request.ReqLoginOtpDTO;
import vn.hoidanit.JobZone.domain.request.ReqSendOtpDTO;
import vn.hoidanit.JobZone.domain.request.ReqUserRegisterDTO;
import vn.hoidanit.JobZone.domain.request.ReqVerifyOtpChangePasswordDTO;
import vn.hoidanit.JobZone.domain.response.ResChangePasswordDTO;
import vn.hoidanit.JobZone.domain.response.ResCreateUserDTO;
import vn.hoidanit.JobZone.domain.response.ResLoginDTO;
import vn.hoidanit.JobZone.domain.response.ResSessionDTO;
import vn.hoidanit.JobZone.repository.UserSessionRepository;
import vn.hoidanit.JobZone.service.OtpService;
import vn.hoidanit.JobZone.service.RedisTokenBlacklistService;
import vn.hoidanit.JobZone.service.UserService;
import vn.hoidanit.JobZone.service.UserSessionService;
...
public class AuthController {
    ...
    public ResponseEntity<Void> sendRegistrationOtp(@Valid @RequestBody ReqSendOtpDTO sendOtpDTO)
        ...
        otpService.sendOtpEmail(sendOtpDTO.getEmail(), otpCode, "Mã OTP Đăng Ký Tài Khoản JobZone");
    ...
    public ResponseEntity<Void> sendLoginOtp(@Valid @RequestBody ReqSendOtpDTO sendOtpDTO) throws IdInvalidException {
        ...
        String otpCode = otpService.generateOtp();
        otpService.saveOtp(sendOtpDTO.getEmail(), otpCode);
        otpService.sendOtpEmail(sendOtpDTO.getEmail(), otpCode, "Mã OTP Đăng nhập JobZone");
