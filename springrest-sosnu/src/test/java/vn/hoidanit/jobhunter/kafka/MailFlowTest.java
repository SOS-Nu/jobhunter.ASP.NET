...
// "spring.kafka.consumer.properties.spring.json.trusted.packages=vn.hoidanit.JobZone.*",
// "spring.kafka.consumer.properties.spring.json.value.default.type=vn.hoidanit.JobZone.kafka.MailCommand",
//
