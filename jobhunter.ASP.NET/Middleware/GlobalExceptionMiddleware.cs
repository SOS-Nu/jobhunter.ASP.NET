...
namespace jobhunter.ASP.NET.Middleware
{
    /// <summary>
    /// Global Exception Middleware.
    /// Maps from: vn.hoidanit.jobhunter.util.error.GlobalException (@RestControllerAdvice)
    ...
    // Maps from: vn.hoidanit.jobhunter.util.error.*
    // ========================
