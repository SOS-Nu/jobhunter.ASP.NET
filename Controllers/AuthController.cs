...
namespace jobhunter.ASP.NET.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IAuthService authService, IUserService userService, IMapper mapper, IConfiguration config)
        {
            _authService = authService; _userService = userService; _mapper = mapper; _config = config;
        }
